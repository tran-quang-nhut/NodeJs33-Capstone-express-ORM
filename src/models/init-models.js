...
function initModels(sequelize) {
  ...
  hinh_anh.belongsToMany(nguoi_dung, { as: 'nguoi_dung_luu_anh', through: luu_anh, foreignKey: "hinh_id", otherKey: "nguoi_dung_id" });
  nguoi_dung.belongsToMany(hinh_anh, { as: 'hinh_id_hinh_anhs', through: binh_luan, foreignKey: "nguoi_dung_id", otherKey: "hinh_id" });
  nguoi_dung.belongsToMany(hinh_anh, { as: 'hinh_anh_da_luu', through: luu_anh, foreignKey: "nguoi_dung_id", otherKey: "hinh_id" });
  ...
  nguoi_dung.hasMany(hinh_anh, { as: "hinh_anh_da_tao", foreignKey: "nguoi_dung_id"});
